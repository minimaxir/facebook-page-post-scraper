...
def get_args():
    parser = \
        ...
        Python Script to scrape Facebook Groups and pages.
This will help you scrape the maximum possible data from the page/group.
Things like comments,reacts etc can be scraped and stored to a .csv file.
For more info: https://github.com/minimaxir/facebook-page-post-scraper''')
    parser.add_argument('-id', type=str,
                        help='App ID generated by facebook.com',
                        required=True)
    parser.add_argument('-secret', type=str,
                        help='App Secret provided by facebook.com',
                        required=True)
    parser.add_argument('-page', type=str,
                        help='ID of the facebook page.', required=True)
    parser.add_argument('-since', type=str,
                        help='Beginning date to scrape.',
                        required=False)
    ...
    return (app_id, page_id, dates)

if __name__ == '__main__':
    (access_token, page_id, dates) = get_args()

    since_date = dates[0] or ''
    until_date = dates[1] or ''
    scrapeFacebookPageFeedStatus(page_id, access_token, since_date,
                                 until_date)
