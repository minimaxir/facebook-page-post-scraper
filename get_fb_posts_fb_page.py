...
def get_args():
    ...
    parser.add_argument('-id', type=str,
                        help='App ID generated by developers.facebook.com',
                        required=True)
    parser.add_argument('-secret', type=str,
                        help='App Secret provided by developers.facebook.com',
                        required=True)
    ...
    limit = args.limit
    return (app_id, page_id, dates, limit)

if __name__ == '__main__':
    (access_token, page_id, dates, limit) = get_args()
    ...
    num_processed = scrapeFacebookPageFeedStatus(page_id, access_token,
